                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('colors.update',$colors->id)}}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="color" name="code" class="form-control form-control-color" id="exampleColorInput" value="{{$colors->code}}" title="Choose your color">
                                            @error('code') <smal class="text-danger">{{$message}}</smal> @enderror

                                            <label>Name</label>
                                            <input type="text" required name="name"   class="form-control" value="{{$colors->name}}">
                                            @error('name') <smal class="text-danger">{{$message}}</smal> @enderror
                                        </div>
                                      {{--  <div class="form-group">
                                            <label>Code</label>
                                            <input type="text"  name="code"  placeholder="Code" class="form-control" value="{{$colors->code}}">
                                            @error('code') <smal class="text-danger">{{$message}}</smal> @enderror
                                        </div>--}}
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        {{$coloreFull->links('pagination::bootstrap-4')}}
                                    </div>
